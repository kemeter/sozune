...
const ENTRIES: &[Entry] = &[
    ...
    Entry {
        ...
        example: Some("sozune.udp.dns.entrypoint=dns  # \"dns\" is a listener in proxy.udp"),
    },
    Entry {
        code: "E006",
        ...
        example: Some("sozune.udp.dns.port=53"),
    },
    Entry {
        code: "W001",
    ...
    Entry {
        ...
        example: Some("sozune.http.web.forwardAuth.address=http://authelia:9091/api/verify"),
    },
    Entry {
        code: "W020",
        ...
        example: Some("sozune.http.web.errorPages.503=<h1>maintenance</h1>"),
    },
    Entry {
        code: "W021",
    ...
    Entry {
        ...
        example: Some("sozune.http.web.loadBalancer=least_connections"),
    },
    Entry {
        code: "W023",
        ...
        example: Some("sozune.http.web.retry.attempts=3"),
    },
    Entry {
        code: "W024",
        ...
        example: Some(
            "sozune.http.web.circuitBreaker.threshold=0.5\nsozune.http.web.circuitBreaker.minRequests=20",
        ),
    },
    Entry {
        code: "W025",
        ...
        example: Some("sozune.http.web.inFlightReq=10"),
    },
    Entry {
        code: "W026",
